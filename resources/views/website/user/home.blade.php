            ...
            <div class="card-body">
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="basic-addon1">To Encrypt</span>
                </div>
                <input type="text" class="form-control" id="request_params" placeholder="request_params" aria-label="request_params" aria-describedby="basic-addon1">
              </div>
              Output:
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                ...
                <input type="text" class="form-control" id="result_params" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
              </div>
                <button class="btn btn-default btn-flat" type="button" id="btn-Pay">Encrypt</button>
                ...
                <a class="btn btn-app">
                    <i class="fas fa-play"></i> Register as Book Author
                </a>
                <a class="btn btn-app">
                    <i class="fas fa-shop"></i> Become a Shop Owner
                </a>
                <a class="btn btn-app">
...
@section('js')
    ...
    <script>
        ...
        $('#btn-Pay').click(function(){
          $('#result_params').val((SHA256($('#request_params').val()))) ;
        });
    </script>
